...
public class Round10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Round.setText("Decima mano");
        TextView WhatToTake = (TextView) findViewById(R.id.WhatToTake);
        WhatToTake.setText("Dichiarazione di " + PlayerNames.getPlayers()[1] + "\nPiù 1 punto per ogni presa");
        ...
        ForwardButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int pointsForToken = Settings.getRound10Points();
                PlayerNames.setRoundPoints(10, PlayerBars[0].getProgress() * pointsForToken,
                        PlayerBars[1].getProgress() * pointsForToken,
                        PlayerBars[2].getProgress() * pointsForToken,
                        PlayerBars[3].getProgress() * pointsForToken);

                Intent OpenNextRound = new Intent(Round10.this, Round11.class);
