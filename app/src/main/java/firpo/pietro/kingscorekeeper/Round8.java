    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PlayerBars[0].setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                if(isSum(1)) ForwardButton.setEnabled(true);
        ...
        ForwardButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int pointsForToken = Settings.getRound8Points();
                int[] points = {-pointsForToken, -pointsForToken, -pointsForToken, -pointsForToken};
                for (int i = 0; i < 4; i++){
                    if (PlayerBars[i].getProgress() == 1){
                        points[i] = pointsForToken;
                    }
                }
                PlayerNames.setRoundPoints(8, points[0], points[1], points[2], points[3]);

                Intent OpenNextRound = new Intent(Round8.this, Round9.class);
