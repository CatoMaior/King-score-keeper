...
public class Round7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Round.setText("Settima mano");
        TextView WhatToTake = (TextView) findViewById(R.id.WhatToTake);
        WhatToTake.setText("Meno mani\nMeno 1 punto per ogni presa");
        ...
        ForwardButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int pointsForToken = Settings.getRound7Points();
                PlayerNames.setRoundPoints(7, PlayerBars[0].getProgress() * pointsForToken,
                        PlayerBars[1].getProgress() * pointsForToken,
                        PlayerBars[2].getProgress() * pointsForToken,
                        PlayerBars[3].getProgress() * pointsForToken);

                Intent OpenNextRound = new Intent(Round7.this, Round8.class);
