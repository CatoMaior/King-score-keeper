...
public class Round6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Round.setText("Sesta mano");
        TextView WhatToTake = (TextView) findViewById(R.id.WhatToTake);
        WhatToTake.setText("No ultime due mani\nMeno 4 punti per ogni presa");
        ...
        PlayerBars[0].setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                if(isSum(2)) ForwardButton.setEnabled(true);
        ...
        ForwardButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int pointsForToken = Settings.getRound6Points();
                PlayerNames.setRoundPoints(6, PlayerBars[0].getProgress() * pointsForToken,
                        PlayerBars[1].getProgress() * pointsForToken,
                        PlayerBars[2].getProgress() * pointsForToken,
                        PlayerBars[3].getProgress() * pointsForToken);

                Intent OpenNextRound = new Intent(Round6.this, Round7.class);
